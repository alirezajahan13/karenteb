...
<div class="cetificatePageBack">
    <div class="certificatePage mainView">
        <div class="generalHeading highMargined centeredText bottomBorder">
            <h1>گواهینامه‌های <div class="changeColorHeader">کارن طب</div></h1>
            <span>کارگروه دانش بنیان تحقیق و توسعه کارن طب</span>
        </div>
