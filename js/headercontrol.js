...
$(document).ready(function(){
    ...
    $('.mobileMenuParent .mainMenu > ul > .menu-item-has-children > a').append('<svg height="18" width="18" xmlns="http://www.w3.org/2000/svg" viewBox="-15 -3 50 50" xml:space="preserve" transform="rotate(90)"><path fill="#187dba" d="M15.563 40.836a.997.997 0 0 0 1.414 0l15-15a.999.999 0 0 0 0-1.414l-15-15a.999.999 0 1 0-1.414 1.414l14.293 14.293-14.293 14.293a.999.999 0 0 0 0 1.414z"/></svg>');
